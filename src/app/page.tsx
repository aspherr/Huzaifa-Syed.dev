    ...
    <main ref={mainRef} className="h-screen overflow-y-scroll scroll-smooth">
      ...
      <section id="home">
        ...
        <div className="flex flex-col items-center justify-start h-screen max-w-screen-xl mx-auto px-6 pt-12 font-mono">
          ...
          {/* technologies 
          <div className="w-full max-w-xl mx-auto mt-3 flex flex-col sm:flex-row md:flex-row lg:flex-row gap-6">
            <div className="border border-zinc-900 rounded-xl px-6 py-4 w-full">
              <h2 className="text-lg sm:text-lg md:text-xl lg:text-2xl font-bold text-blue-600 mb-5">My Technologies</h2>

              <div className="grid grid-cols-4 gap-8 place-items-center auto-rows-min [&>svg]:w-8 [&>svg]:h-8">
            ...
            <div className='flex flex-col w-full md:w-auto'>
              ...
              <div className="h-12 mt-4 border border-zinc-900 rounded-xl px-4 py-2 flex items-center justify-center text-center bg-blue-600 hover:border-white duration-300 transition-all w-full">
