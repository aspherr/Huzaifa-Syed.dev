  ...
  return (
    ...
    >
      <div className="p-4 pb-5 leading-tight">
        ...
        <div className={`relative flex overflow-hidden items-center justify-center mb-5 mt-2 md:mt-0 rounded-lg border-zinc-900 bg-neutral-800 w-full ${hasImage ? "h-full" : "h-46"}`}>
          {hasImage ? (
            <>
              {image}
